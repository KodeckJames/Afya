...
def get_pubmed_data(
        ...
        email: str = 'otienookoth007@gmail.com',
        articles: str = '',
    ...
    query = f"({articles} articles from {start_date}[Date - Publication] : {end_date}[Date - Publication])"
...
if __name__ == "__main__":
    get_pubmed_data(output_json_file='output.json', start_date='2023/12/1', end_date='2023/12/31',
                    max_num_articles=50,articles='malaria')